...
class DIDChat {
  constructor(containerId) {
    ...
    this.chatUrl =
      "https://studio.d-id.com/agents/share?id=v2_agt_0pXzzqC8&utm_source=copy&key=WjI5dloyeGxMVzloZFhSb01ud3hNVEkyTkRNNE9UTTVNVEV3TXpFMk9EYzNPRFE2V2s1QlFWQnZZalExUTFRM2Vtb3RlazQwT0dGMg==";
    this.iframe = null;
    this.init();
  }
